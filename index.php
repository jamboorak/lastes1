...
<main>
    ...
    <section id="welcome" class="section welcome-contact" style="background: linear-gradient(rgba(15, 23, 42, 0.72), rgba(15, 23, 42, 0.78)), url('images/welcome section background2.webp') center/cover no-repeat; padding: 5rem 0;">
        <div class="container">
            ...
            <div class="contact-cards" style="display: grid; grid-template-columns: repeat(3, minmax(300px, 360px)); gap: 2.5rem; width: min(100%, 1200px); justify-content: center; justify-items: center; align-items: start; margin: 0 auto;">
                <!-- Contact card -->
                <div class="contact-card" style="background: white; border-radius: 14px; box-shadow: 0 18px 40px rgba(15, 23, 42, 0.06); padding: 1.6rem 1.25rem; min-height: 260px; max-width: 360px; margin: 0 auto; display: flex; flex-direction: column; align-items: center; text-align: center; gap: 0.75rem;">
                    <div style="width: 48px; height: 48px; display: grid; place-items: center; background: rgba(249, 115, 22, 0.12); border-radius: 12px;">
                        <i class="fas fa-phone" style="font-size: 1.25rem; color: var(--accent-orange);"></i>
                    </div>
                    <h3 style="margin: 0; font-size: 1.05rem; color: var(--primary-blue); font-weight: 700;">Contact Us</h3>
                    <div style="width: 100%; display: flex; flex-direction: column; gap: 0.35rem; align-items: center;">
                        <p style="margin: 0; color: #475569; line-height: 1.6;"><strong style="color: var(--text-dark);">Phone No.:</strong> 09690204045</p>
                        <p style="margin: 0; color: #475569; line-height: 1.6;"><strong style="color: var(--text-dark);">Email:</strong> Villasoledadgardernresort@gmail.com</p>
                        <p style="margin: 0; color: #475569; line-height: 1.6;"><strong style="color: var(--text-dark);">Facebook:</strong> Villa Soledad Garden Resort</p>
                    </div>
                </div>
                <div class="contact-card" style="background: white; border-radius: 14px; box-shadow: 0 18px 40px rgba(15, 23, 42, 0.06); padding: 1.6rem 1.25rem; min-height: 260px; max-width: 360px; margin: 0 auto; display: flex; flex-direction: column; align-items: center; text-align: center; gap: 0.75rem;">
                    <div style="width: 48px; height: 48px; display: grid; place-items: center; background: rgba(249, 115, 22, 0.12); border-radius: 12px;">
                    ...
                    <h3 style="margin: 0; font-size: 1.05rem; color: var(--primary-blue); font-weight: 700;">Tour Hours</h3>
                    <div style="width: 100%; display: flex; flex-direction: column; gap: 0.35rem; align-items: center;">
                        <p style="margin: 0; color: #475569; line-height: 1.6;"><strong style="color: var(--text-dark);">Day Tour Hours</strong> 8:00 AM - 5:00 PM</p>
                        <p style="margin: 0; color: #475569; line-height: 1.6;"><strong style="color: var(--text-dark);">Night Tour Hours</strong> 8:00 PM - 5:00 AM</p>
                    </div>
                </div>
                <div class="contact-card" style="background: white; border-radius: 14px; box-shadow: 0 18px 40px rgba(15, 23, 42, 0.06); padding: 1.6rem 1.25rem; min-height: 260px; max-width: 360px; margin: 0 auto; display: flex; flex-direction: column; align-items: center; text-align: center; gap: 0.75rem;">
                    <div style="width: 48px; height: 48px; display: grid; place-items: center; background: rgba(249, 115, 22, 0.12); border-radius: 12px;">
                    ...
                    <h3 style="margin: 0; font-size: 1.05rem; color: var(--primary-blue); font-weight: 700;">Entrance Fees</h3>
                    <div style="width: 100%; display: flex; flex-direction: column; gap: 0.35rem; align-items: center;">
                        <p style="margin: 0; color: #475569; line-height: 1.6;"><strong style="color: var(--text-dark);">Day Rate:</strong> ₱150/Adult, ₱80/Child</p>
                        <p style="margin: 0; color: #475569; line-height: 1.6;"><strong style="color: var(--text-dark);">Night Rate:</strong> ₱180/Adult, ₱100/Child</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Rooms Section -->
    <section id="rooms" class="facilities" style="background: var(--white); padding: 3rem 0 2rem;">
        <div class="container">
                            ...
                            <div class="room-card room-card-<?php echo $index; ?>" style="position: absolute; top: 0; left: 50%; width: 360px; height: 480px; transform-style: preserve-3d; transform-origin: center center; transition: transform 0.8s ease, opacity 0.8s ease;">
                                <div style="width: 100%; height: 100%; border-radius: 28px; overflow: hidden; box-shadow: 0 28px 60px rgba(15, 23, 42, 0.14); background: #fff; display: flex; flex-direction: column;">
                                    ...
                                    <div style="padding: 1.5rem; flex: 1; display: flex; flex-direction: column;">
                                        ...
                                        <p style="color: #475569; line-height: 1.6; margin-bottom: auto; margin-top: 0;"><?php echo htmlspecialchars($room['description'] ?? ''); ?></p>
                                        <div style="display: flex; align-items: center; justify-content: space-between; gap: 1rem; margin-top: 1rem;">
                                            <span style="color: var(--accent-orange); font-weight: 700;">₱<?php echo number_format((float)($room['price_per_night'] ?? 0), 2); ?></span>
                                            <button type="button" onclick="openModalRoom('<?php echo str_replace("'", "\\'", htmlspecialchars($room['name'] ?? 'Room', ENT_QUOTES)); ?>', '<?php echo str_replace("'", "\\'", htmlspecialchars($room['description'] ?? '', ENT_QUOTES)); ?>', '₱<?php echo number_format((float)($room['price_per_night'] ?? 0), 2); ?>')" style="background: var(--accent-orange); color: white; border: none; padding: 0.8rem 1.2rem; border-radius: 999px; cursor: pointer; font-weight: 700;">Details</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div id="descriptionModalRoom" style="display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.7); z-index: 2000; align-items: center; justify-content: center;">
        <div style="background: white; padding: 2rem; border-radius: 10px; max-width: 400px; width: 90%; box-shadow: 0 10px 40px rgba(0,0,0,0.3);">
            ...
            <p id="modalDescriptionRoom" style="color: var(--text-dark); margin-bottom: 1rem; line-height: 1.6;"></p>
    ...
    <!-- Cottages Section -->
    <section id="cottages" style="background: var(--white); padding: 3rem 0 2rem;">
        <div class="container">
    ...
    <!-- Pools Section -->
    <section id="pools" style="background: var(--white); padding: 3rem 0 2rem; display: none;">
        <div class="container">
                            ...
                            <div style="width: 100%; height: 100%; border-radius: 28px; overflow: hidden; box-shadow: 0 28px 60px rgba(15, 23, 42, 0.14); background: #fff;">
                                ...
                                <div style="padding: 1.5rem;">
                                    ...
                                    <div style="display: flex; align-items: center; justify-content: space-between; gap: 1rem;">
                                        ...
                                        <button onclick="openModalPool('Guest Pool', 'A spacious guest pool ideal for relaxing swims and social time with family.', 'FREE for guests')" style="background: var(--accent-orange); color: white; border: none; padding: 0.8rem 1.2rem; border-radius: 999px; cursor: pointer; font-weight: 700;">Details</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="pool-card pool-card-1" style="position: absolute; top: 0; left: 50%; width: 360px; height: 420px; transform-style: preserve-3d; transform-origin: center center; transition: transform 0.8s ease, opacity 0.8s ease;">
                            <div style="width: 100%; height: 100%; border-radius: 28px; overflow: hidden; box-shadow: 0 28px 60px rgba(15, 23, 42, 0.14); background: #fff;">
                                ...
                                <div style="padding: 1.5rem;">
                                    ...
                                    <div style="display: flex; align-items: center; justify-content: space-between; gap: 1rem;">
                                        <span style="color: var(--accent-orange); font-weight: 700;">FREE for guests</span>
                                        <button onclick="openModalPool('Kids Pool', 'A safe, shallow pool designed for children and family fun.', 'FREE for guests')" style="background: var(--accent-orange); color: white; border: none; padding: 0.8rem 1.2rem; border-radius: 999px; cursor: pointer; font-weight: 700;">Details</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div style="width: 100%; height: 100%; border-radius: 28px; overflow: hidden; box-shadow: 0 28px 60px rgba(15, 23, 42, 0.14); background: #fff;">
                                ...
                                <div style="padding: 1.5rem;">
                                    ...
                                    <div style="display: flex; align-items: center; justify-content: space-between; gap: 1rem;">
                                        ...
                                        <button onclick="openModalPool('Private Pool', 'An exclusive private pool for guests seeking privacy and tranquility.', 'FREE for guests')" style="background: var(--accent-orange); color: white; border: none; padding: 0.8rem 1.2rem; border-radius: 999px; cursor: pointer; font-weight: 700;">Details</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function openModalRoom(title, description, price) {
            document.getElementById('modalTitleRoom').textContent = title;
            document.getElementById('modalDescriptionRoom').textContent = description;
            document.getElementById('modalPriceRoom').textContent = price;
        ...
        function updatePageSections() {
            ...
            const sectionIds = [...homeSections, 'rooms', 'cottages', 'pools', 'facade'];
            ...
            sectionIds.forEach(id => {
                ...
                const isFacade = id === 'facade';
                const shouldShowFacade = isFacade && homeSections.includes(target);
                section.style.display = (isHomeTarget || isSpecialTarget || shouldShowFacade) ? 'block' : 'none';
            });
        }
    ...
    <section id="location" class="location">
        <div class="container">
            <div class="location-header">
                <h2>IT'S LOCATED AT</h2>
                <p class="location-text"><i class="fas fa-map-marker-alt"></i> Brgy. Soledad, San Pablo City, Laguna</p>
            </div>
            <div class="map-container">
                <div>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3870.6601965650625!2d121.3124313108307!3d14.038145390542423!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33bd4301035b4ef3%3A0xd22111becbb8a4!2sVilla%20Soledad%20Garden%20Resort!5e0!3m2!1sen!2sph!4v1777265586353!5m2!1sen!2sph" width="100%" height="100%" style="border:none; border-radius: 10px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Facade Section -->
    <section id="facade" class="section" style="background: var(--bg-light); padding: 4rem 0;">
        <div class="container">
            <div style="text-align: center; margin-bottom: 3rem;">
                <h2 style="color: var(--primary-blue); font-size: 2.5rem; font-weight: 700; margin-bottom: 1rem; position: relative; display: inline-block;">
                    FACADE
                    <span style="position: absolute; bottom: -10px; left: 0; right: 0; height: 4px; background: var(--accent-orange); border-radius: 2px;"></span>
                </h2>
            </div>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem; max-width: 800px; margin: 0 auto;">
                <div style="background: var(--primary-blue); border-radius: 20px; height: 400px; display: flex; align-items: center; justify-content: center; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease; overflow: hidden;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 15px 40px rgba(0, 0, 0, 0.15)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 10px 30px rgba(0, 0, 0, 0.1)';">
                    <img src="image1.png" alt="Facade 1" style="width: 100%; height: 100%; object-fit: cover; display: block;">
                </div>
                <div style="background: var(--primary-blue); border-radius: 20px; height: 400px; display: flex; align-items: center; justify-content: center; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease; overflow: hidden;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 15px 40px rgba(0, 0, 0, 0.15)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 10px 30px rgba(0, 0, 0, 0.1)';">
                    <img src="image2.png" alt="Facade 2" style="width: 100%; height: 100%; object-fit: cover; display: block;">
                </div>
            </div>
        </div>
    </section>
